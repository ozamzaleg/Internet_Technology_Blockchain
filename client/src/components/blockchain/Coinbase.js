...
const Coinbase = ({ coinbase, setCoinbase }) => {
    return (
        <div className="row">
            ...
            <div className="col-75">
                ...
                <input type='number' step='0.01' defaultValue={coinbase.miningReward} onChange={e => setCoinbase({ ...coinbase, miningReward: Number(e.target.value) })} className='input_data_three_variables' />
